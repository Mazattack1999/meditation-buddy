...
function loadHomePage() {
  ...
  homeHeader.setAttribute(
    "style",
    "background-image:url(" + randomImage.src.portrait + ");"
  );
...
function loadMeditation(object) {
  ...
  medMain.setAttribute(
    "style",
    "background-image:url(" + image.src.portrait + ");"
  );
...
//   console.log(localStorage.getItem("search-result"));
  ...
  window.location.pathname === "/meditation-buddy/"
) {
...
//clear all favorites in local storage
